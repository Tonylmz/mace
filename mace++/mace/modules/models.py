...
class ScaleShiftMACE(MACE):
    ...
    def forward(
        ...
        hyper_edge_index_row = data["edge_index"][0][index_leq]
        hyper_edge_index_col = data["edge_index"][1][index_leq]
        hyper_lengths = scatter_mean(src=lengths[hyper_edge_index_col], index=hyper_edge_index_row, dim=0, dim_size=node_feats.shape[0])
        ...
        for interaction, product, readout in zip(
            ...
            hyper_node_feats = scatter_mean(node_feats[hyper_edge_index_col], hyper_edge_index_row, dim=0, dim_size=node_feats.size(0))
            node_feats, sc = interaction(
                node_attrs=data["node_attrs"],
                node_feats=node_feats,
                edge_attrs=edge_attrs,
                edge_feats=edge_feats,
                edge_index=data["edge_index"],
                hyper_edge_attrs=hyper_edge_attrs,
                hyper_edge_feats=hyper_edge_feats,
